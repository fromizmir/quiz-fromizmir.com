document.addEventListener('DOMContentLoaded', () => {
    ...
    async function fetchAndDisplayQuizzes() {
        try {
            ...
            if (!response.ok) throw new Error(`Sınav listesi alınamadı. Sunucu Durumu: ${response.status}`);
    ...
    async function startQuiz(quizId) {
        ...
        try {
            ...
            if (!response.ok) throw new Error('Sınav verileri alınamadı.');
